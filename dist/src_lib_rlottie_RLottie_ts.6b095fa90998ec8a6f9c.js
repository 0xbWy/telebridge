"use strict";
(self["webpackChunktelebridge"] = self["webpackChunktelebridge"] || []).push([["src_lib_rlottie_RLottie_ts"],{
...
class RLottie {
  ...
  speed = 1;
  direction = 1;
  requestedSeekToEnd = false;
  static init(...args) {
    const [, canvas, renderId, params, viewId = (0,_util_generateUniqueId__WEBPACK_IMPORTED_MODULE_4__["default"])(),, onLoad,,, onFrame] = args;
  ...
  constructor(tgsUrl, container, renderId, params, viewId = (0,_util_generateUniqueId__WEBPACK_IMPORTED_MODULE_4__["default"])(), customColor, onLoad, onEnded, onLoop, onFrame) {
    this.tgsUrl = tgsUrl;
  ...
  addView(viewId, container, onLoad, onFrame, coords) {
    const sizeFactor = this.calcSizeFactor();
    let imgSize;
...
class ConnectorClass {
  ...
  postMessagesOnTickEnd = (0,_schedulers__WEBPACK_IMPORTED_MODULE_1__.throttleWithTickEnd)(() => {
    const {
      channel
    } = this;
...
//# sourceMappingURL=src_lib_rlottie_RLottie_ts.6b095fa90998ec8a6f9c.js.map