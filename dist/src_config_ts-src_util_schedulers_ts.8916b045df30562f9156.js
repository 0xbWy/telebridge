"use strict";
(self["webpackChunktelebridge"] = self["webpackChunktelebridge"] || []).push([["src_config_ts-src_util_schedulers_ts"],{
...
/* harmony export */   COCOON_EMOJI_ID: () => (/* binding */ COCOON_EMOJI_ID),
...
/* harmony export */   FALLBACK_LANG_CODE: () => (/* binding */ FALLBACK_LANG_CODE),
...
/* harmony export */   FOLDERS_POSITION_DEFAULT: () => (/* binding */ FOLDERS_POSITION_DEFAULT),
/* harmony export */   FOLDERS_POSITION_LEFT: () => (/* binding */ FOLDERS_POSITION_LEFT),
/* harmony export */   FOLDERS_POSITION_TOP: () => (/* binding */ FOLDERS_POSITION_TOP),
/* harmony export */   FOLDER_TITLE_MAX_LENGTH: () => (/* binding */ FOLDER_TITLE_MAX_LENGTH),
/* harmony export */   FORCE_FALLBACK_LANG: () => (/* binding */ FORCE_FALLBACK_LANG),
...
/* harmony export */   INTERCLIENT_BROADCAST_CHANNEL: () => (/* binding */ INTERCLIENT_BROADCAST_CHANNEL),
...
/* harmony export */   LOCAL_MESSAGES_LIMIT: () => (/* binding */ LOCAL_MESSAGES_LIMIT),
...
/* harmony export */   MUTE_INDEFINITE_TIMESTAMP: () => (/* binding */ MUTE_INDEFINITE_TIMESTAMP),
/* harmony export */   NBSP: () => (/* binding */ NBSP),
/* harmony export */   NNBSP: () => (/* binding */ NNBSP),
...
/* harmony export */   PAGE_TITLE_TAURI: () => (/* binding */ PAGE_TITLE_TAURI),
...
/* harmony export */   POLL_UNREAD_SLICE: () => (/* binding */ POLL_UNREAD_SLICE),
...
/* harmony export */   SLOT_MACHINE_EMOJI: () => (/* binding */ SLOT_MACHINE_EMOJI),
...
/* harmony export */   STORYBOARD_MAP_MIME: () => (/* binding */ STORYBOARD_MAP_MIME),
/* harmony export */   STORYBOARD_MIME: () => (/* binding */ STORYBOARD_MIME),
...
/* harmony export */   UNMUTE_TIMESTAMP: () => (/* binding */ UNMUTE_TIMESTAMP),
...
/* harmony export */   VT_CLASS_NAME: () => (/* binding */ VT_CLASS_NAME),
/* harmony export */   VT_TYPE_CLASS_PREFIX: () => (/* binding */ VT_TYPE_CLASS_PREFIX),
...
const APP_NAME =  false || 'TeleBridge';
const PRODUCTION_HOSTNAME = 'telebridge.online';
const PRODUCTION_URL = 'https://telebridge.online/a';
const WEB_VERSION_BASE = 'https://telebridge.online/'; // Used to redirect to other versions
const BASE_URL = "https://telebridge.online/a/";
...
const FORCE_FALLBACK_LANG = DEBUG;
...
const PAGE_TITLE = "TeleBridge";
const PAGE_TITLE_TAURI = 'TeleBridge';
...
const LANG_CACHE_NAME = 'tt-lang-packs-v51';
...
const INTERCLIENT_BROADCAST_CHANNEL = 'tgweb';
...
const NBSP = '\u00A0';
const NNBSP = '\u202F';
const FOLDERS_POSITION_TOP = 'top';
const FOLDERS_POSITION_LEFT = 'left';
const FOLDERS_POSITION_DEFAULT = FOLDERS_POSITION_TOP;
...
const VT_CLASS_NAME = 'active-view-transition';
const VT_TYPE_CLASS_PREFIX = 'active-vt-';
...
const TMP_CHAT_ID = '0';
const MUTE_INDEFINITE_TIMESTAMP = MAX_INT_32;
const UNMUTE_TIMESTAMP = 0;
...
const BASE_EMOJI_KEYWORD_LANG = FALLBACK_LANG_CODE;
...
const STORYBOARD_MIME = 'application/x-tgstoryboard';
const STORYBOARD_MAP_MIME = 'application/x-tgstoryboardmap';
...
const COCOON_EMOJI_ID = '5197252827247841976';
const LOCAL_MESSAGES_LIMIT = 1e6; // 1M
const CHANNEL_ID_BASE = 10n ** 12n;
...
const DELETED_COMMENTS_CHANNEL_ID = (-CHANNEL_ID_BASE - 777n).toString();
...
const DARK_THEME_BG_COLOR = '#000000';
const DEFAULT_PATTERN_COLOR = '#4A8E3A8C';
const DARK_THEME_PATTERN_COLOR = '#48576166';
...
//# sourceMappingURL=src_config_ts-src_util_schedulers_ts.8916b045df30562f9156.js.map