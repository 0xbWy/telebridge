(self["webpackChunktelebridge"] = self["webpackChunktelebridge"] || []).push([["vendors-node_modules_music-metadata_lib_ParserFactory_js-node_modules_music-metadata_lib_core_js"],{
...
/* harmony export */   normalizeSampleSize: () => (/* binding */ normalizeSampleSize),
...
function findZipDataDescriptorOffset(buffer, bytesConsumed) {
	...
	for (let index = 0; index <= lastPossibleDescriptorOffset; index++) {
		if (
			token_types__WEBPACK_IMPORTED_MODULE_0__.UINT32_LE.get(buffer, index) === zipDataDescriptorSignature
			&& token_types__WEBPACK_IMPORTED_MODULE_0__.UINT32_LE.get(buffer, index + 8) === bytesConsumed + index
		) {
			return index;
		}
	}
...
_tokenizer_inflate__WEBPACK_IMPORTED_MODULE_2__.ZipHandler.prototype.inflate = async function (zipHeader, fileData, callback) {
	if (zipHeader.compressedMethod === 0) {
...
_tokenizer_inflate__WEBPACK_IMPORTED_MODULE_2__.ZipHandler.prototype.unzip = async function (fileCallback) {
	let stop = false;
	let zipEntryCount = 0;
	...
	do {
		...
		if (zipHeader.dataDescriptor) {
			...
			if (token_types__WEBPACK_IMPORTED_MODULE_0__.UINT32_LE.get(dataDescriptor, 0) !== zipDataDescriptorSignature) {
...
class FileTypeParser {
	...
	createTokenizerFromWebStream(stream) {
		return patchWebByobTokenizerClose(strtok3_core__WEBPACK_IMPORTED_MODULE_1__.fromWebStream(stream, this.getTokenizerOptions()));
	}
	...
	async fromBuffer(input) {
		...
		return this.fromTokenizer(strtok3_core__WEBPACK_IMPORTED_MODULE_1__.fromBuffer(buffer, this.getTokenizerOptions()));
	}

	async fromBlob(blob) {
		this.options.signal?.throwIfAborted();
		const tokenizer = strtok3_core__WEBPACK_IMPORTED_MODULE_1__.fromBlob(blob, this.getTokenizerOptions());
			...
			async function readChildren(children) {
				...
				while (children > 0) {
					...
					if (element.id === 0x42_82) {
						...
						const rawValue = await tokenizer.readToken(new token_types__WEBPACK_IMPORTED_MODULE_0__.StringType(documentTypeLength));
							...
							if (
								!isUnknownPngStream
									&& (
										...
										|| error instanceof strtok3_core__WEBPACK_IMPORTED_MODULE_1__.EndOfStreamError
									)
							) {
								return pngFileType;
							}
...
//# sourceMappingURL=vendors-node_modules_music-metadata_lib_ParserFactory_js-node_modules_music-metadata_lib_core_js.656e45b59f005b164f03.js.map