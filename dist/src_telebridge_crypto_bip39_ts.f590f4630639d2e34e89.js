"use strict";
(self["webpackChunktelebridge"] = self["webpackChunktelebridge"] || []).push([["src_telebridge_crypto_bip39_ts"],{

/***/ "./src/telebridge/crypto/bip39.ts"
/*!****************************************!*\
  !*** ./src/telebridge/crypto/bip39.ts ***!
  \****************************************/
...
/* harmony export */   MNEMONIC_WORD_COUNT: () => (/* binding */ MNEMONIC_WORD_COUNT),
/* harmony export */   generateMnemonic: () => (/* binding */ generateMnemonic),
/* harmony export */   isBIP39Available: () => (/* binding */ isBIP39Available),
/* harmony export */   mnemonicToKey: () => (/* binding */ mnemonicToKey),
...
function generateMnemonic() {
  return bip39__WEBPACK_IMPORTED_MODULE_2__.generateMnemonic(ENTROPY_BITS_24_WORDS);
}
...
function validateMnemonic(mnemonic) {
  ...
  return bip39__WEBPACK_IMPORTED_MODULE_2__.validateMnemonic(mnemonic);
}
...
function mnemonicToSeed(mnemonic, passphrase) {
  ...
  const seed = bip39__WEBPACK_IMPORTED_MODULE_2__.mnemonicToSeedSync(mnemonic, passphrase);
 ...
 */
function mnemonicToKey(mnemonic, passphrase) {
  ...
  const key = new Uint8Array((0,_noble_hashes_hkdf_js__WEBPACK_IMPORTED_MODULE_0__.hkdf)(_noble_hashes_sha2_js__WEBPACK_IMPORTED_MODULE_1__.sha256, seed, new Uint8Array(32), BIP39_KEY_INFO, 32));
  return key;
}
...
//# sourceMappingURL=src_telebridge_crypto_bip39_ts.f590f4630639d2e34e89.js.map