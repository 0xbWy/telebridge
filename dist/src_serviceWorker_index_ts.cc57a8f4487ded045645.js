...
/* harmony export */   IS_TAURI: () => (/* binding */ IS_TAURI)
/* harmony export */ });
...
const IS_TAURI = (0,_tauri_apps_api_core__WEBPACK_IMPORTED_MODULE_0__.isTauri)();
// @ts-expect-error no types for electron
const IS_ELECTRON = Boolean(globalThis.electron);
...
function getAccountsInfo() {
  ...
  const allSlots = allKeys.filter(key => key.startsWith(_config__WEBPACK_IMPORTED_MODULE_0__.SESSION_ACCOUNT_PREFIX));
  const accountInfo = {};
  for (const key of allSlots) {
    const i = Number(key.slice(_config__WEBPACK_IMPORTED_MODULE_0__.SESSION_ACCOUNT_PREFIX.length));
...
function getAccountSlotUrl(slot, forLogin, isTest) {
...
if (typeof window === 'object') {
  ...
  versionChannel.addEventListener('message', event => {
    ...
    if (!version) return;
    if (semverCompare("12.0.25", version) === -1) {
...
/******/ 		var __webpack_exports__ = __webpack_require__.O(undefined, ["vendors-node_modules_tauri-apps_api_core_js","src_config_ts-src_util_schedulers_ts"], () => (__webpack_require__("./src/serviceWorker/index.ts")))
...
/******/ 			return "" + chunkId + "." + {"vendors-node_modules_tauri-apps_api_core_js":"2ab4ce0e040ca38ae446","src_config_ts-src_util_schedulers_ts":"8916b045df30562f9156"}[chunkId] + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ 		};
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunktelebridge"] = self["webpackChunktelebridge"] || [];
...
/******/ 		__webpack_require__.x = () => {
/******/ 			return Promise.all([
/******/ 				__webpack_require__.e("vendors-node_modules_tauri-apps_api_core_js"),
...
/******/ })()
;
//# sourceMappingURL=src_serviceWorker_index_ts.cc57a8f4487ded045645.js.map