"use strict";
(self["webpackChunktelebridge"] = self["webpackChunktelebridge"] || []).push([["vendors-node_modules_music-metadata_lib_id3v2_ID3v2Parser_js"],{
...
/* harmony export */   getFrameHeaderLength: () => (/* binding */ getFrameHeaderLength),
...
/* harmony import */ var _borewit_text_codec__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @borewit/text-codec */ "./node_modules/@borewit/text-codec/lib/index.js");
/* harmony import */ var _FrameParser_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./FrameParser.js */ "./node_modules/music-metadata/lib/id3v2/FrameParser.js");
...
function parseFrameHeaderV22(uint8Array, majorVer, warningCollector) {
    const header = {
        id: (0,_borewit_text_codec__WEBPACK_IMPORTED_MODULE_3__.textDecode)(uint8Array.subarray(0, 3), 'ascii'),
...
function parseFrameHeaderV23V24(uint8Array, majorVer, warningCollector) {
    const header = {
        id: (0,_borewit_text_codec__WEBPACK_IMPORTED_MODULE_3__.textDecode)(uint8Array.subarray(0, 4), 'ascii'),
        length: (majorVer === 4 ? _ID3v2Token_js__WEBPACK_IMPORTED_MODULE_2__.UINT32SYNCSAFE : token_types__WEBPACK_IMPORTED_MODULE_0__.UINT32_BE).get(uint8Array, 4),
...
function makeUnexpectedMajorVersionError(majorVer) {
    throw new _FrameParser_js__WEBPACK_IMPORTED_MODULE_4__.Id3v2ContentError(`Unexpected majorVer: ${majorVer}`);
}
...
/* harmony import */ var _ID3v2ChapterToken_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./ID3v2ChapterToken.js */ "./node_modules/music-metadata/lib/id3v2/ID3v2ChapterToken.js");
/* harmony import */ var _FrameHeader_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./FrameHeader.js */ "./node_modules/music-metadata/lib/id3v2/FrameHeader.js");
...
function parseGenreCode(code) {
    ...
    if (code === 'CR')
        return 'Cover';
    if (code.match(/^\d*$/)) {
        return _id3v1_ID3v1Parser_js__WEBPACK_IMPORTED_MODULE_4__.Genres[Number.parseInt(code, 10)];
    }
}
class FrameParser {
    /**
    ...
    readData(uint8Array, type, includeCovers) {
        ...
        switch (type !== 'TXXX' && type[0] === 'T' ? 'T*' : type) {
            ...
            case 'PCST': {
                let text;
                try {
                    text = FrameParser.trimNullPadding(_common_Util_js__WEBPACK_IMPORTED_MODULE_2__.decodeString(uint8Array.subarray(1), encoding));
                }
                catch (error) {
            ...
            case 'APIC':
                if (includeCovers) {
                    ...
                    switch (this.major) {
                        case 2:
                            pic.format = _common_Util_js__WEBPACK_IMPORTED_MODULE_2__.decodeString(uint8Array.subarray(0, 3), 'latin1'); // 'latin1'; // latin1 == iso-8859-1;
                            uint8Array = uint8Array.subarray(3);
                            break;
                        case 3:
                        case 4:
                            fzero = _common_Util_js__WEBPACK_IMPORTED_MODULE_2__.findZero(uint8Array, defaultEnc);
                            pic.format = _common_Util_js__WEBPACK_IMPORTED_MODULE_2__.decodeString(uint8Array.subarray(0, fzero), defaultEnc);
                    ...
                    pic.type = _ID3v2Token_js__WEBPACK_IMPORTED_MODULE_3__.AttachedPictureType[uint8Array[0]];
                    uint8Array = uint8Array.subarray(1);
                    fzero = _common_Util_js__WEBPACK_IMPORTED_MODULE_2__.findZero(uint8Array, encoding);
                    pic.description = _common_Util_js__WEBPACK_IMPORTED_MODULE_2__.decodeString(uint8Array.subarray(0, fzero), encoding);
            ...
            case 'CNT':
            case 'PCNT':
                output = (0,_common_Util_js__WEBPACK_IMPORTED_MODULE_2__.decodeUintBE)(uint8Array);
                break;
            case 'SYLT': {
                const syltHeader = _ID3v2Token_js__WEBPACK_IMPORTED_MODULE_3__.SyncTextHeader.get(uint8Array, 0);
                uint8Array = uint8Array.subarray(_ID3v2Token_js__WEBPACK_IMPORTED_MODULE_3__.SyncTextHeader.len);
                const result = {
                    descriptor: '',
                ...
                while (uint8Array.length > 0) {
                    ...
                    if (readSyllables) {
                        const timestamp = token_types__WEBPACK_IMPORTED_MODULE_1__.UINT32_BE.get(uint8Array, 0);
                        uint8Array = uint8Array.subarray(token_types__WEBPACK_IMPORTED_MODULE_1__.UINT32_BE.len);
            ...
            case 'POPM': { // Popularimeter
                ...
                const rating = token_types__WEBPACK_IMPORTED_MODULE_1__.UINT8.get(uint8Array, 0);
                const counterBytes = uint8Array.subarray(token_types__WEBPACK_IMPORTED_MODULE_1__.UINT8.len);
                output = {
                    email,
                    rating,
                    counter: counterBytes.length > 0 ? (0,_common_Util_js__WEBPACK_IMPORTED_MODULE_2__.decodeUintBE)(counterBytes) : undefined
                };
                break;
            }
            case 'GEOB': { // General encapsulated object
                // [encoding] <MIME> 0x00 <filename> 0x00/0x00 0x00 <description> 0x00/0x00 0x00 <data>
                const encoding = _ID3v2Token_js__WEBPACK_IMPORTED_MODULE_3__.TextEncodingToken.get(uint8Array, 0);
                uint8Array = uint8Array.subarray(1);
            ...
            case 'WXXX': {
                ...
                output = { description, url: FrameParser.trimNullPadding(_common_Util_js__WEBPACK_IMPORTED_MODULE_2__.decodeString(uint8Array, defaultEnc)) };
                break;
            }
            case 'WFD':
            case 'WFED': {
            ...
            case 'CHAP': { //  // Chapter frame
                ...
                fzero = _common_Util_js__WEBPACK_IMPORTED_MODULE_2__.findZero(uint8Array, defaultEnc);
                const chapter = {
                    label: _common_Util_js__WEBPACK_IMPORTED_MODULE_2__.decodeString(uint8Array.subarray(0, fzero), defaultEnc),
                    info: _ID3v2ChapterToken_js__WEBPACK_IMPORTED_MODULE_6__.ChapterInfo.get(uint8Array, fzero + 1),
                    frames: new Map()
                };
                offset += fzero + 1 + _ID3v2ChapterToken_js__WEBPACK_IMPORTED_MODULE_6__.ChapterInfo.len;
                while (offset < length) {
                    const subFrame = (0,_FrameHeader_js__WEBPACK_IMPORTED_MODULE_7__.readFrameHeader)(uint8Array.subarray(offset), this.major, this.warningCollector);
                    const headerSize = (0,_FrameHeader_js__WEBPACK_IMPORTED_MODULE_7__.getFrameHeaderLength)(this.major);
                    offset += headerSize;
            ...
            case 'CTOC': { // Table of contents frame
                ...
                const idEnd = _common_Util_js__WEBPACK_IMPORTED_MODULE_2__.findZero(uint8Array, defaultEnc);
                const label = _common_Util_js__WEBPACK_IMPORTED_MODULE_2__.decodeString(uint8Array.subarray(0, idEnd), defaultEnc);
                offset = idEnd + 1;
                // Flags
                ...
                for (let i = 0; i < entryCount && offset < length; i++) {
                    const end = _common_Util_js__WEBPACK_IMPORTED_MODULE_2__.findZero(uint8Array.subarray(offset), defaultEnc);
                    const childId = _common_Util_js__WEBPACK_IMPORTED_MODULE_2__.decodeString(uint8Array.subarray(offset, offset + end), defaultEnc);
    ...
    static readNullTerminatedString(uint8Array, encoding) {
        ...
        const zeroIndex = _common_Util_js__WEBPACK_IMPORTED_MODULE_2__.findZero(valueArray, encoding.encoding);
        if (zeroIndex >= valueArray.length) {
            // No terminator found, decode full buffer remainder
            return {
                text: _common_Util_js__WEBPACK_IMPORTED_MODULE_2__.decodeString(valueArray, encoding.encoding),
                len: originalLen
            };
        }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   ChapterInfo: () => (/* binding */ ChapterInfo)
/* harmony export */ });
/* harmony import */ var token_types__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! token-types */ "./node_modules/token-types/lib/index.js");
...
const ChapterInfo = {
    len: 16,
    get: (buf, off) => {
        const startOffset = token_types__WEBPACK_IMPORTED_MODULE_0__.UINT32_BE.get(buf, off + 8);
        const endOffset = token_types__WEBPACK_IMPORTED_MODULE_0__.UINT32_BE.get(buf, off + 12);
        return {
            startTime: token_types__WEBPACK_IMPORTED_MODULE_0__.UINT32_BE.get(buf, off),
            endTime: token_types__WEBPACK_IMPORTED_MODULE_0__.UINT32_BE.get(buf, off + 4),
...
/* harmony export */ });
/* harmony import */ var token_types__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! token-types */ "./node_modules/token-types/lib/index.js");
/* harmony import */ var _FrameParser_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./FrameParser.js */ "./node_modules/music-metadata/lib/id3v2/FrameParser.js");
/* harmony import */ var _ID3v2Token_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ID3v2Token.js */ "./node_modules/music-metadata/lib/id3v2/ID3v2Token.js");
/* harmony import */ var _FrameHeader_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./FrameHeader.js */ "./node_modules/music-metadata/lib/id3v2/FrameHeader.js");
...
class ID3v2Parser {
    ...
    static readFrameData(uint8Array, frameHeader, majorVer, includeCovers, warningCollector) {
        const frameParser = new _FrameParser_js__WEBPACK_IMPORTED_MODULE_1__.FrameParser(majorVer, warningCollector);
        switch (majorVer) {
            case 2:
    ...
    async parse(metadata, tokenizer, options) {
        ...
        const id3Header = await this.tokenizer.readToken(_ID3v2Token_js__WEBPACK_IMPORTED_MODULE_2__.ID3v2Header);
        if (id3Header.fileIdentifier !== 'ID3') {
            throw new _FrameParser_js__WEBPACK_IMPORTED_MODULE_1__.Id3v2ContentError('expected ID3-header file-identifier \'ID3\' was not found');
        }
    ...
    async parseExtendedHeader() {
        const extendedHeader = await this.tokenizer.readToken(_ID3v2Token_js__WEBPACK_IMPORTED_MODULE_2__.ExtendedHeader);
        const dataRemaining = extendedHeader.size - _ID3v2Token_js__WEBPACK_IMPORTED_MODULE_2__.ExtendedHeader.len;
    ...
    parseMetadata(data) {
        ...
        while (true) {
            if (offset === data.length)
                break;
            const frameHeaderLength = (0,_FrameHeader_js__WEBPACK_IMPORTED_MODULE_3__.getFrameHeaderLength)(this.id3Header.version.major);
            ...
            const frameHeader = (0,_FrameHeader_js__WEBPACK_IMPORTED_MODULE_3__.readFrameHeader)(frameHeaderBytes, this.id3Header.version.major, this.metadata);
...
function makeUnexpectedMajorVersionError(majorVer) {
    throw new _FrameParser_js__WEBPACK_IMPORTED_MODULE_1__.Id3v2ContentError(`Unexpected majorVer: ${majorVer}`);
}
...
//# sourceMappingURL=vendors-node_modules_music-metadata_lib_id3v2_ID3v2Parser_js.f3b4d415db57cf958291.js.map